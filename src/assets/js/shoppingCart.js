    ...
    if (cartArray.length <= 0) {
        ...
        for (var i in cartArray) {
            output
                ...
                +"<small class='cart_ref'><label>Mã sản phẩm : </label> <label id='masp'>"+cartArray[i].productcode+"<label></small>"
                +"<br>"
                +"</td>"
    ...
    if (cartArray.length <= 0) {
        ...
        for (var i in cartArray) {
            output
                ...
                +"<td class='cart_description'>"
                +"<p class='product-name'><a href='#'>"+cartArray[i].name+"</a></p>"
                +"<small class='cart_ref'>Mã sản phẩm : <input type='text' name='masp"+i+"' value='"+cartArray[i].productcode+"' readonly /></small>"
                +"<br>"
                +"</td>"
                +"<td class='price'><span style='color: #e84d1c; font-size: 18px; font-weight: bold;'>" + numberWithCommas(cartArray[i].price) + "<input type='text' style='display:none;' name='dongia"+i+"' value='"+cartArray[i].price+"' /></span></td>"
                +"<td class='qty'>"
                //+"<input class='form-control input-sm' type='text' readonly value='" + cartArray[i].count + "'>"
                +"<label> <input type='text' name='soluong"+i+"' value='" + cartArray[i].count + "' readonly /></label>"
                +"</td>"
                +"<td class='price'>"
                +"<span style='color: #e84d1c; font-size: 18px; font-weight: bold;'>" + numberWithCommas(cartArray[i].total) + "</span>"
                +"</td>"
